---
title: Terraform Scripting
description: Simplifying Terraform Development Environment Setup
summary: Shell Script designed for the express purpose of Starting a Terraform Environment using Amazon Web Services
...
{{< figure src="/images/terraform/terraform-decoded.png" size="200x200" >}} {{< load-photoswipe >}}
